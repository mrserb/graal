...
* (GR-61365) Improved URL protocol reachability metadata collection. The Tracing Agent no longer records the JAR URL protocol handler for application classpath resource URLs, while explicit `jar:` and `jrt:` URL protocol use remains recorded.
